...
class ProductReviewList extends StatefulWidget {
  ...
  const ProductReviewList({super.key, this.product, this.store});
...
class BasicInfoReview extends StatelessWidget {
  ...
  const BasicInfoReview({super.key, this.product, this.store});
...
class BasicProductReview extends StatelessWidget with ProductMixin {
  ...
  const BasicProductReview({super.key, this.product});

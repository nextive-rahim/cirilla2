...
class Categories extends StatefulWidget {
  ...
  const Categories({super.key, this.categories, this.data});
...
class SubCategories extends StatefulWidget {
  ...
  const SubCategories({super.key, this.productCategory, this.data});
...
class _IconButton extends StatelessWidget {
  ...
  const _IconButton({super.key, this.onPressed, this.active = false});
